...
const heart = (props) => (
  ...
  const spade = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" {...props}>
      <path d="M9.996 40c7.211-1.603 7.987-5.826 8.531-13.594-1.253 2.075-3.531 3.607-7.25 3.594-6.112-.021-10.207-3.576-8.75-11.25C3.996 11.013 14.996 8.013 19.996 0c5 8.013 16 11.013 17.469 18.75 1.456 7.674-2.469 11.228-8.75 11.25-3.719.013-5.997-1.519-7.25-3.594.544 7.768 1.319 11.991 8.531 13.594h-20z" />
    </svg>
  )
